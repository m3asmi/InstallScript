...
if [ ! -f $OE_HOME_EXT/odoo-bin ]; then
	wget "https://raw.githubusercontent.com/odoo/odoo/$VERSION.0/odoo-bin"
	chmod 755 odoo-bin
else echo -e  "\n--- odoo-bin exist"
fi
...
sudo npm install -g rtlcss #arabic and hibrue
...
server {
  ...
  # ssl_certificate_key /odoo/.local/share/Odoo/letsencrypt/$WEBSITE_NAME.key;
